...
This project is indexed by GitNexus as **transcriptoz** (259 symbols, 299 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/transcriptoz/context` | Codebase overview, check index freshness |
| `gitnexus://repo/transcriptoz/clusters` | All functional areas |
| `gitnexus://repo/transcriptoz/processes` | All execution flows |
| `gitnexus://repo/transcriptoz/process/{name}` | Step-by-step execution trace |
